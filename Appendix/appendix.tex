...
We then take a \textit{full price} and the {fee} paid by FONASA affiliates in the Free Choice Modality (MLE) as a reference price, from a tariff book assembled by FONASA itself (2024). We take this to correspond to the physician's revenue by visit ($r$) and the patients' cost of visit ($\tau$), respectively.
